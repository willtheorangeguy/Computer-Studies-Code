...
# Make Karel turn right, using abstraction
def turn_right():
    turn_left()
    turn_left()
    turn_left()
...
## ANOTHER SOLUTION:
### Make Karel turn right, using the reverse of left
#def turn_right():
#    global karel, direction
#    
#    if direction == EAST:
...
def move():
    global X_POS, Y_POS, karel, direction
    if direction == EAST:
        X_POS = X_POS + KAREL_SIZE
    elif direction == WEST:
        X_POS = X_POS - KAREL_SIZE
    elif direction == NORTH:
        Y_POS = Y_POS - KAREL_SIZE
    elif direction == SOUTH:
        Y_POS = Y_POS + KAREL_SIZE
    else:
        print("Error: Karel's Direction is not properly set.")
